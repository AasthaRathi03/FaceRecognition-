...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        img = img.resize((500,220), Image.LANCZOS)
        ...
        img1= img1.resize((500,220), Image.LANCZOS)
        self.photoimg1 = ImageTk.PhotoImage(img1)

        f_lbl=Label(self.root,image=self.photoimg1)
        f_lbl.place(x=500,y=0,width=500,height=180)

        #third image


        img2 = Image.open(r"C:\Users\Aastha Rathi\Downloads\next.jpg")
        img2= img2.resize((500,220), Image.LANCZOS)
        self.photoimg2 = ImageTk.PhotoImage(img2)

        f_lbl=Label(self.root,image=self.photoimg2)
        f_lbl.place(x=1000,y=0,width=500,height=180)
        ...
        b1.place(x=500,y=60,width=220,height=220)
        ...
        b1.place(x=800,y=60,width=220,height=220)
        ...
        b1.place(x=1100,y=60,width=220,height=220)
       ...
       #Train face button 
        ...
        b1.place(x=200,y=320,width=220,height=220)
        ...
        b1_1.place(x=200,y=520,width=220,height=40)
